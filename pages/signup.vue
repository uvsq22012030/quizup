          ...
          <form class="text-center">
            ...
            <div class="py-2 text-center">
              <div class="flex-1 w-full items-center">
                ...
                />
                <label
                  class="bg-gray-300 hover:bg-red-300 text-gray-800 font-semibold py-2 px-4 cursor-pointer rounded-r rounded-l"
                  for="male"
                >
                  Male</label
                >
                ...
                />
                <label
                  class="bg-gray-300 hover:bg-red-300 text-gray-800 font-semibold py-2 px-4 rounded-l rounded-r cursor-pointer"
                  for="female"
                >
                  Female</label
                >
                ...
                />
                <label
                  class="bg-gray-300 hover:bg-red-300 text-gray-800 font-semibold py-2 px-4 cursor-pointer rounded-l rounded-r"
                  for="non-binary"
                >
                  Other</label
                >
